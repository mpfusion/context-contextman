...
Tento povel se pí¹e v~deklaraèní oblasti va¹eho vstupního souboru.
...
Mìly by jste se obeznámit s~parametry, které popisují vá¹ formát stránek. 
...
\placefigure
  ...
  {Formát stránky.}
  {\hbox{\framed[width=1.5cm,frame=off]{}
   \framed[width=2cm,frame=off]{\tt levý}
   \framed[width=2.5cm,frame=off]{\tt levý}
   \framed[width=3cm,frame=off]{\tt text}
   \framed[width=2.5cm,frame=off]{\tt pravý}
   \framed[width=2cm,frame=off]{\tt pravý}}
   \hbox{\framed[width=1.5cm,frame=off]{}
   \framed[width=2cm,frame=off]{\tt roh}
   ...
   \framed[width=2.5cm]{}
   \framed[width=2cm]{}}
   \hbox{\framed[width=1.5cm,frame=off]{\tt hlavièka}
   \framed[width=2cm]{}
   \framed[width=2.5cm]{}
   \framed[width=3cm]{}
   \framed[width=2.5cm]{}
   ...
   \framed[width=2.5cm,height=3cm]{}
   \framed[width=2cm,height=3cm]{}}
   \hbox{\framed[width=1.5cm,frame=off]{\tt pata}
   \framed[width=2cm]{}
   \framed[width=2.5cm]{}
   \framed[width=3cm]{}
   \framed[width=2.5cm]{}
...
Kdy¾ chcete vidìt vá¹ formát stránek, mù¾ete napsat pøíkaz \type{\showframe} a
zpracovat jednu stranu nebo celý soubor. Oblasti jsou vyznaèeny jako nìkolik
rámeèkù.
...
Toto vám umo¾ní pøesnìji definovat rozmìry sloupcù, obrázkù 
...
Jestli¾e chcete definovat ¹íøku sloupce nebo vý¹ku obrázku
mù¾ete to udìlat relativnì k~hodnotám \type{\makeupwidth}
...
va¹eho vstupního souboru, pøed povelem \type{\starttext}. 
To znamená, ¾e hodnoty parametrù jsou globální a platné
pro celý dokument. 
Nicménì pro nìkteré stránky mù¾ete chtít vykonat  
drobné zmìny rozvr¾ení stránky.
...
%height.
V~tomto pøípadì budou mít strany 21 a 38 vý¹ku rovnou 0,5~cm + pøedvolená vý¹ka stránky.
...
Hasselt má úplnì jiné uspoøádání jako vìt¹na jiných mìst kvùli 
...
\starttables[|l|l|]
\NC vzdálenost záhlaví   \NC \type{\topheight}           \NC\FR
\NC vý¹ka záhlaví        \NC \type{\topheight}           \NC\MR
\NC vzdálenost hlavièky  \NC \type{\headerdistance}      \NC\MR
\NC vý¹ka hlavièky       \NC \type{\headerheight}        \NC\MR
\NC horní mezera         \NC \type{\topspace}            \NC\MR
\NC úroveò hlavièky      \NC \type{\headerlevel}         \NC\MR
\NC backspace            \NC \type{\backspace}           \NC\MR
\NC vzdálenost okraje    \NC \type{\margindistance}      \NC\MR
\NC ¹íøka okraje         \NC \type{\marginwidth}         \NC\MR
\NC ¹íøka levého okraje  \NC \type{\leftmarginwidth}     \NC\MR
\NC ¹íøka pravého okraje \NC \type{\rightmarginwidth}    \NC\MR
\NC vzdálenost rohu      \NC \type{\edgedistance}        \NC\MR
\NC ¹íøka rohu           \NC \type{\edgewidth}           \NC\MR
\NC ¹íøka levého rohu    \NC \type{\leftedgewidth}       \NC\MR
\NC ¹íøka pravého rohu   \NC \type{\rightedgewidth}      \NC\MR
...
\NC vzdálenost paty      \NC \type{\footerdistance}      \NC\MR
\NC vý¹ka paty           \NC \type{\footerheight}        \NC\MR
\NC vzdálenost úpatí     \NC \type{\bottomdistance}      \NC\MR
\NC vý¹ka úpatí          \NC \type{\bottomheight}        \NC\LR
\stoptables
