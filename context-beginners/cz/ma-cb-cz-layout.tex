...
Tento povel se pí¹e v~deklaraèní oblasti na¹eho vstupního souboru.
...
(stránkové zrcadlo). 
Stránka je rozdìlena na nìkolik oblastí jako napøíklad text, hlavièka, pata atd. 
...
\placefigure
  ...
  {Formát stránky.}
  {\hbox{\framed[width=1.5cm,frame=off]{}
   \framed[width=2cm,frame=off]{\tt levá}
   \framed[width=2.5cm,frame=off]{\tt levý}
   \framed[width=3cm,frame=off]{}
   \framed[width=2.5cm,frame=off]{\tt pravý}
   \framed[width=2cm,frame=off]{\tt pravá}}
   \hbox{\framed[width=1.5cm,frame=off]{}
   \framed[width=2cm,frame=off]{\tt hrana}
   \framed[width=2.5cm,frame=off]{\tt okraj}
   \framed[width=3cm,frame=off]{\tt text}
   \framed[width=2.5cm,frame=off]{\tt okraj}
   \framed[width=2cm,frame=off]{\tt hrana}}
   \hbox{\framed[width=1.5cm,frame=off]{\tt vr¹ek}
   \framed[width=2cm]{}
   \framed[width=2.5cm]{}
   \framed[width=3cm]{}
   \framed[width=2.5cm]{}
   \framed[width=2cm]{}}
   \hbox{\framed[width=1.5cm,frame=off]{\tt záhlaví}
   \framed[width=2cm]{}
   \framed[width=2.5cm]{}
   \framed[width=3cm]{}
   \framed[width=2.5cm]{}
   ...
   \framed[width=2.5cm,height=3cm]{}
   \framed[width=2cm,height=3cm]{}}
   \hbox{\framed[width=1.5cm,frame=off]{\tt úpatí}
   \framed[width=2cm]{}
   \framed[width=2.5cm]{}
   \framed[width=3cm]{}
   \framed[width=2.5cm]{}
   \framed[width=2cm]{}}
   \hbox{\framed[width=1.5cm,frame=off]{\tt spodek}
   \framed[width=2cm]{}
   \framed[width=2.5cm]{}
   \framed[width=3cm]{}
   \framed[width=2.5cm]{}
...
na¹eho vstupního souboru, pøed povelem \type{\starttext}. 
