...
%below is available.
V~mnoha pøípadech chtìjí autoøi pou¾ívat urèitá slova stejnì v~celém
...
%contains a command.
První dvojice hranatých závorek obsahuje singulární tvar synonyma a
druhá dvojice obsahuje plurální formu. Tøetí dvojice hranatých závorek
obsahuje povel.
...
Nyní je k~dispozici pøíkaz \type{\abbreviation} a mù¾e být pou¾it na
definování na¹ich zkratek:
