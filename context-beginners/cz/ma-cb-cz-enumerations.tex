...
v dokumentu vytvoøit, pou¾ijeme:
...
Nyní jsou k~dispozici pøíkazy \type{\remark}, \type{\subremark},
\type{\resetremark} a \type{\nextremark}, tak¾e mù¾eme psát poznámky typu:
...
Pomocí \type{\resetremark} nebo \type{\resetsubremark} 
mù¾eme opìt èíslovat od zaèátku. Èíslo zvý¹íme pomocí
...
místì koná bohoslu¾ba pod ¹irým nebem.
\stopremark
\stopbuffer
