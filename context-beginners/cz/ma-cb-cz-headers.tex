...
První pár závorek se pou¾ívá pro upøesnìní umístìní záhlaví nebo
zápatí (text, margin=marginálie, edge=vnìj¹í okraj, viz
\at{obrázek}[fig:pagelayout]). Zápatí a~záhlaví jsou urèeny druhou
a~tøetí závorkou. V~oboustranných dokumentech dodáme ètvrtou a~pátou
závorku pro nastavení záhlaví/zápatí levých a~pravých 
