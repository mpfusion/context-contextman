...
Obrázky a~fotografie mohou být vlo¾eny do na¹eho 
...
\NC top        \NC umísti obrázek na horní okraj stránky  \NC\MR
\NC bottom     \NC umísti obrázek na dolní okraj stránky  \NC\MR
\NC left       \NC umísti obrázek do levého okraje        \NC\MR
\NC right      \NC umísti obrázek do pravého okraje       \NC\MR
...
Obrázky pro ná¹ dokument èasto vytváøíme pomocí programù jako Corel Draw
nebo Illustrator. Fotky -- po oskenování -- se obvykle upraví
v~\GIMP{}u nebo PhotoShopu. Po této práci, máme své obrázky ve formì
...
souborù \type{PDF}, stejnì tak jako výstup \METAPOST{}u, (soubory typu
\type{MPS}). U¾ivatelé mohou bì¾nì dùvìøovat \CONTEXT{}u, ¾e nalezne
...
Umístìní a rozmìry obrázku mù¾eme ovlivòit pomocí:

\shortsetup{setupfloats}

%You can set up the numbering and the labels with:
Také mù¾eme nastavit èíslování obrázkù a~jejich popisek:
...
Následující pøíkazy patøí do deklaraèní oblasti na¹eho vstupního
