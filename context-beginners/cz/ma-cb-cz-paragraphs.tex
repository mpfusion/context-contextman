...
a~lépe strukturovaný text, ve které se snadnìji odhalují pøípadné
chyby.
...
\startbuffer
Bìhem jedné z~válek byl Hasselt v~oble¾ení. Po nìjakém
èase dolehl na mìsto hladomor a~v¹e co se dalo sníst,
...
Hasseltu se zde dnes nachází kamenná deska
s~vyobrazením krávy.
\stopbuffer
...
%really needed!
dostaneme lep¹í výstup. Pou¾ívejme ale tyto pøíkazy jen
...
mezeru relativnì, odvozenou od velikosti daného fontu.
...
Rozumné odsazení je dosa¾eno pomocí:
...
%is suppressed.
Tímto budou odstavce odsazeny. Jen po mezeøe (vysázené pøíkazem
...
Kdy¾ napøíklad pou¾ijeme \type{never}, od toho okam¾iku
