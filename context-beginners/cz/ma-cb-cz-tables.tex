...
\from{manuál}[manual:nattab] a \from{magazín}[myway:nattab]. Pozn. pøekl.}

Do~definic \TABLE\ bylo oproti originálu pøidáno nìkolik maker
zaji¹»ujících konzistentnìj¹í øádkování a bylo
zjednodu¹eno u¾ivatelské rozhraní.\footnote{\CONTEXT\ byl vyvinut pro
  u¾ivatele (také) bez technického nadání v~éøe \cap{WYSIWIG}. Proto
