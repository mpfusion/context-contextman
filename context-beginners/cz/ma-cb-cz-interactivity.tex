...
Interaktivní dokument po kliknutí my¹í na urèitou jeho plochu, zobrazí
jinou plochu, která byla odkazována. Pøíkladem mù¾e být klik na èíslo strány
polo¾ky rejstøíku a následné zobrazení odpovídající strany dokumentu.
...
\item aktivní menu v~navigaèních panelech stran.
\stopitemize
...
dokument prohlí¾íme. Pøedpokládejme, ¾e pou¾ijeme \PDFTEX\ pro
generování \PDF\ dokumentu pøímo nebo pou¾ijeme \DISTILLER\ pro
pøevedení \POSTSCRIPT ového souboru na soubor \PDF. Je zøejmé, ¾e pak
pro zobrazení pou¾ijeme \READER, \EXCHANGE\ nebo \GHOSTVIEW.
...
se dùvìrnì obeznámit s~mo¾nostmi \CONTEXT u.\footnote{Pozn. pøekl.:
  Interaktivitì je vìnován manuál {\em Widgets uncovered}.}
...
bratranci, proto¾e hyperlinky spotøebují spoustu kódové
informace. Také si v¹imnìnte, ¾e zpracování dokumentu probíhá
pomaleji. Proto je výhodné deaktivovat interaktivní mód bìhem
pøípravných fází tvorby dokumentu.
...
V~interaktivním módu máme k~dispozici jeden dal¹í pøíkaz, který má
...
Slo¾ené závorky obsahují text, hranaté odkaz (logické jmého nebo
umístìní).
...
závorek obsahuje jméno souboru a poslední závorky obklopují titulek
vnìj¹ího dokumentu.
...
Jak jste mohli vidìt, \type{::} oddìluje (logické) jméno souboru
a~jméno doskoku v~tomto dokumentu.
...
%% up the menu.
První pár závorek definuje logické jméno, které mù¾e pozdìji být
