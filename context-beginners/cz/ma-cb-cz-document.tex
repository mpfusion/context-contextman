...
Øeknìme, ¾e chcete vytvoøit jednoduchý dokument.
...
%running \CONTEXT.
\CONTEXT\ doká¾e takový dokument vytvoøit automaticky, kdy¾ mu poskytnete
správný vstup ve formì souboru. Nejprve tedy musíte vytvoøit 
vstupní soubor. Úplný název vstupního souboru se skládá ze jména a~pøípony. 
Jméno mù¾ete zvolit libovolné, ale pøípona musí být \type{tex}. 
Kdy¾ vytvoøíte soubor s~názvem \type{mujsoubor.tex}, nebudete mít
...
Mù¾ete samozøejmì pou¾ívat libovolný textový editor nebo procesor, 
...
oznaèíte zaèátek textu. Oblast pøed pøíkazem \type{\starttext} se nazývá
...
èítaèù nebo interaktivních vlastností se nyní nebereme vìnovat.

%If you have \CONTEXT\ process this example file, you would
%obtain a very simple document with a few numbered chapters
%and section headers.
Kdy¾ necháte \CONTEXT\ zpracovat uvedený vzorový soubor, získáte 
...
Proto musíte tento soubor zpracovat dvakrát (dvojprùchodová úloha). 
