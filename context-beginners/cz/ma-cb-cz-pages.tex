...
%options]
Volby se zadávají uvnitø hranatých závorek. Volby a jejich smysl jsou
...
%a page number with:
Èíslování stránek je automatické, ale mù¾eme nastavit èíslo stránky
pøíkazem:
...
Umístìní èísla stránek na stranì závisí na na¹ich zálíbách a na typu
