...
uvnitø dokumentu. Pokud se chcete odkázat na tento nadpis,
mù¾ete napsat napø. \type{\at{str.}[hasselt-v-noci]}.
...
Tyto nadpisy lze samozøejmì pøizpùsobit va¹emu vkusu a dají
...
Je¹tì o jednom povelu byste mìli vìdìt, a to \type{\setupheads}.
