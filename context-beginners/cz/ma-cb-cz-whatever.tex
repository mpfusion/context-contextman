...
V~oboustránkovém dokumentu musíme vykonat nìkteré dal¹í akce,
...
element, napø. tabulka èi obrázek, který zpracováváme speciálním
...
\startframedtext
Na zaèátku tohoto stolení existovala tavmvajová linka z~Zwolle do
...
\begincestina[blok-a]
Po roce 1810 pøinesl Dedemsvaart Hesseltu prosperitu. V¹echny lodì
proplouvaly kanálem v~Hasseltu a obchody na obou stranách kanálu
bohatly.
\endcestina
...
Jestli¾e chcete vidìt, co má Hasselt v~obchodech, mìli byste jej nìkdy
nav¹tívit. Jestli si s~sebou vemete tento manuál, poznáte nìkterá místa.
\stopbuffer
...
Více linek najednou pak pomocí
...
\type{\thinrules} nesmí být opomenuty a~vertiální odsazení je v¾dy
bodem pozornosti. 
...
Tyto pøíkazy bývají pou¾ívány v~dotaznících. Omezením je, ¾e podrhnutý
...
Nový øádek mù¾e být vynucen pøíkazem

\shortsetup{crlf}

%% When a number of lines should be followed by {\em carriage
%% return and line feed} you can use:
Pokud chceme, aby konce øádkù kopírovaly ukonèení ve vstupním souboru,
napí¹eme:
...
Tato malá básnièka obsahuje varování pro radní Hasseltu: nepøijímej
