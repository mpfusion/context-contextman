...
je k~dispozici pøíkaz \type{\index}. Jestli¾e chceme pøidat do
rejstøíku slovo, napí¹eme napøíklad: 
...
seøazen podle abecedy pomocným programem. Pokud je nìkteré heslo
...
%defined as follows:
Nìkdy máme pod- nebo podpodhesla. Tyto se zadávají následujícím zpùsobem:
...
Zobrazení rejstøíkù mù¾eme mìnit pøíkazem:
