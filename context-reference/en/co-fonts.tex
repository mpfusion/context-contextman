...
wrapped inside of those.  Still, you will need to know about body font
definitions if you want to create your own typescripts, so \dots
...
A concrete size will be provided by the commands at the top||level in the
...
The use of the \type{delault} actually happens deep inside \CONTEXT\ so
