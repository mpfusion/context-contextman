...
(either declared by \type{\usetypescriptfile} or one of the automatically
loaded files).
...
Extra arguments to \type{\starttypescript} are not ignored. However, you
can force any key at all to match by using the special keyword \type{all}.
We will see later that this is sometimes handy.
...
have to be scanned, but quite some are, and some even more than once:

\todo{check execution order}

\starttabulate[|l|l|l|l|]
\NC type-syn.tex \NC serif \NC palatino \NC name                     \NC\NR
\NC type-syn.tex \NC serif \NC palatino \NC name                     \NC\NR
\NC type-enc.tex \NC serif \NC palatino \NC texnansi,ec,8r,t5        \NC\NR
\NC type-enc.tex \NC serif \NC palatino \NC ec,texnansi,8r           \NC\NR
...
\NC type-map.tex \NC map   \NC palatino \NC default,ec,texnansi,t5,8r\NC\NR
\NC type-map.tex \NC map   \NC palatino \NC ec,texnansi,t5,8r        \NC\NR
