...
This is already useful, but \CONTEXT\ goes further than that.
An extra synonym level is normally defined that maps this font name to a
generic name like \type{Serif} or \type{Sans}.
...
\placetable
  ...
  {Standard symbolic font names}
  {\getbuffer[symfontnames]}

\section {Simple font definitions}

The most simple font definition takes place with \type {\definefont}. If
you want a fixed size, you can define a font as follows:
