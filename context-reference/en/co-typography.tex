...
right you can see what would have happened if when the interline space
...
the identifier can also be a font collection identifier that has been
defined in a font support file. \CONTEXT\ expects that you will define
your own font collections |<|which is why there are no extra keywords
listed in the macro syntax definition|>| but luckily there are a
number of predefined identifiers that come with \CONTEXT; these are listed 
in~\in{table}[tab:body font names] etc.
