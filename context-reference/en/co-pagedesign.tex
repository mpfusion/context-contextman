...
On order to get information on the current settings the following
...
\placefigure
	...
	{\startcombination[2*1]
		{\externalfigure[2*16][page=1,width=.45\textwidth]}{recto}
		{\externalfigure[2*16][page=2,width=.45\textwidth]}{verso}
	\stopcombination}
...
\placefigure
	...
	{\startcombination[2*1]
		{\externalfigure[2*8][page=1,width=.45\textwidth]}{recto}
		{\externalfigure[2*8][page=2,width=.45\textwidth]}{verso}
	\stopcombination}
...
\placefigure
	...
	{\startcombination[2*1]
		{\externalfigure[2*4][page=1,width=.45\textwidth]}{recto}
		{\externalfigure[2*4][page=2,width=.45\textwidth]}{verso}
	\stopcombination}
...
\placefigure
	...
	{\startcombination[2*1]
		{\externalfigure[2*2][page=1,width=.45\textwidth]}{recto}
		{\externalfigure[2*2][page=2,width=.45\textwidth]}{verso}
	\stopcombination}
\stoppostponing
...
\starttabulate[|l|l|r|]
	\NC \bf Arrangement \NC \bf Result \NC \bf Number of pages \NC\NR
	\NC \type{\setuparranging[2*4*2] } \NC section: $2 \times 4$ pages on 2 sheets \EQ 16 pages \NC\NR
	\NC \type{\setuparranging[2*2*4] } \NC section: $2 \times 2$ pages on 4 sheets \EQ 16 pages \NC\NR 
\stoptabulate
...
\placefigure
	...
	{\startcombination[2*2]
		{\externalfigure[2*4*2][page=1,width=.45\textwidth]}{1\high{st} sheet recto}
		{\externalfigure[2*4*2][page=2,width=.45\textwidth]}{1\high{st} sheet verso}
		{\externalfigure[2*4*2][page=3,width=.45\textwidth]}{2\high{nd} sheet recto}
		{\externalfigure[2*4*2][page=4,width=.45\textwidth]}{2\high{nd} sheet verso}
	\stopcombination}
...
\placefigure
	...
	{\startcombination[2*4]
		{\externalfigure[2*2*4][page=1,height=.2\textheight]}{1\high{st} sheet recto}
		{\externalfigure[2*2*4][page=2,height=.2\textheight]}{1\high{st} sheet verso}
		{\externalfigure[2*2*4][page=3,height=.2\textheight]}{2\high{nd} sheet recto}
		{\externalfigure[2*2*4][page=4,height=.2\textheight]}{2\high{nd} sheet verso}
		{\externalfigure[2*2*4][page=5,height=.2\textheight]}{3\high{rd} sheet recto}
		{\externalfigure[2*2*4][page=6,height=.2\textheight]}{3\high{rd} sheet verso}
		{\externalfigure[2*2*4][page=7,height=.2\textheight]}{4\high{th} sheet recto}
		{\externalfigure[2*2*4][page=8,height=.2\textheight]}{4\high{th} sheet verso}
	\stopcombination}
\stoppostponing
...
\placefigure
	...
	{4 pages, singlesided, 1 sheet} % \type{\setuparranging[1*4]}}
		{\externalfigure[1*4][page=1,width=.45\textwidth]}
...
\placefigure
	...
	{\startcombination[2*1]
		{\externalfigure[2*6*Z-HOR][page=1,width=.45\textwidth]}{recto}
		{\externalfigure[2*6*Z-HOR][page=2,width=.45\textwidth]}{verso} 
	\stopcombination}
\stoppostponing
...
\placefigure
	...
	{\startcombination[2*1]
		{\externalfigure[2*8-VER][page=1,width=.45\textwidth]}{recto}
		{\externalfigure[2*8-VER][page=2,width=.45\textwidth]}{verso} 
	\stopcombination}
\stoppostponing
