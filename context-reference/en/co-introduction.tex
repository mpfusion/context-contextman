...
(\type {\}). An example of a command is \type {\sl}. Most
of the time a command does something with the text that
comes after the command. The text after the command \type
{\sl} will be typeset {\sl slanted}.

When you use a command like \type{\sl} you acting as a  typesetter,
and when you are writing paragraps you are acting as an author.
...
By using \type{\em} instead of \type{\sl}, you enable the typesetter (who could also be you) to change the typeset result without him or her having to alter the text.
...
programmers. A collection of macros is called a macropackage. 
