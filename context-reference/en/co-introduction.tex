...
digits, dashes and dots in their names, otherwise you can easily get into
problems. Especially the characters *, ?, the space character and some more
are known to cause problems, sometimes because of \ConTeXt\ itself (internal
pattern matching), sometimes because of issues with the underlying operating
system.
